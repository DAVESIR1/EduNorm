...
const DEFAULT_STAFF_FIELDS = [
    ...
    { id: 'working_standard', label: 'Primary Class/Standard', type: 'text' },
    { id: 'subject', label: 'Primary Subject', type: 'text' },
    { id: 'blood_group', label: 'Blood Group', type: 'select', options: ['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'] },
    { id: 'students_count', label: 'Assigned Students Count', type: 'number' },
    { id: 'last_standard', label: 'Previous Class Handled', type: 'text' },
    { id: 'last_subject', label: 'Previous Subject Handled', type: 'text' },
